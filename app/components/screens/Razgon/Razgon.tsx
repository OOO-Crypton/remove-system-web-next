...
const Razgon: FC = () => {
	return (
		<div className={styles.container}>
			...
			/>
			<p>
				2021 — год массовой популярности криптовалют. Биткоин уже взял уровень
			...
			<Heading
				style={{ textAlign: 'center' }}
				title="Какие криптовалюты майнить в 2021 году?"
			/>
			<p>
				В конце 2020 года и начале 2021 года максимально прибыльной в майнинге
				монетой был Эфириум. Это также Ethereum, ETH или просто «эфир» на
				майнерском жаргоне.
			</p>
			<p>
				Для эффективного майнинга эфира в 2021 году необходима карта с 5 ГБ и
			...
			<div>
				...
				<p>
					...
					дней. 20 февраля 2021 года он установил рекорд на уровне 28.5 цента.
				</p>
				<p>
				...
				<Heading style={{ textAlign: 'center' }} title="Постскриптум" />
				<p>
					Весь 2021 год обещает быть очень продуктивным по новым моделям карт, а
					с появлением каждой новой карты или программ-майнеров расклад сил
					может существенно измениться. Возможно, мы увидим и новые алгоритмы
					майнинга — кто знает. Статья в текущем виде актуальна на начало марта
					2021 и будет активно дополняться по мере поступления новых данных.
				</p>
			</div>
		</div>
	)
